...
@import AVFoundation;
@interface HWQRCodeViewController ()<AVCaptureMetadataOutputObjectsDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>{
    UILabel * introLab;
    BOOL isLightOn;
    UIButton *mineQRCode;
...
@implementation HWQRCodeViewController
